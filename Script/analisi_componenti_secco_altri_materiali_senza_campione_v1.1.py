"""
SCRIPT ANALISI QUANTITATIVA COMPONENTI A SECCO / ALTRI MATERIALI SENZA AREA CAMPIONE - VERSIONE 1.1
...
class AnalisiComponentiSeccoAltriMaterialiSenzaCampione(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA COMPONENTI A SECCO / ALTRI MATERIALI SENZA AREA CAMPIONE - v1.1")
        ...
        context.layerToLoadOnCompletionDetails(results['output_rilievo']).name = "analisi_rilievo_componenti_secco_altri_materiali"
...
END'''
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Componenti a Secco / Altri Materiali Senza Area Campione - Versione 1.1</h3>
